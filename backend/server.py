    ...
    while True:
        ...
        for idx in range(len(odd_fret_boxes)):
            ...
            if idx == 0 or idx== 4 or idx == 5:
                resized_frame = draw_first_fret_boxes(guitar_notes, resized_frame, curr_box, 3, idx + 1)
            else:
                resized_frame = draw_first_fret_boxes(guitar_notes, resized_frame, curr_box, 2, idx + 1)
